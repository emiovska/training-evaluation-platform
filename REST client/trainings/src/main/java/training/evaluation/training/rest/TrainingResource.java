...
public class TrainingResource {
    ...
    public ResponseEntity<Training> createTraining(@ApiParam(value = "Training in JSON format. Name and Level are required fields, Description field is optional. ID is autogenerated.", required = true) @Valid @RequestBody Training training) {
